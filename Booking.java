...
public class Booking {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement search= wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("div[ref*='pageloader']>div>span.button-continue-text")));
		search.click();
				
		//driver.findElement(By.cssSelector("div[ref*='pageloader']>div>span.button-continue-text")).click();
		...
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);				
		 ...
		 driver.findElement(By.id("button-continue-text-paynow")).click();
	}
}
